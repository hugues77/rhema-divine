...
<section class="bg-bible bg-tchat">
            ...
            <div class="alert alert-primary mt-2">
                <div class="row">
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Livre<i class="fas fa-caret-down ml-1"></i></h3>
                            </div>
                            <div class="col-md-6">
                                <h3>Chapitre<i class="fas fa-caret-down ml-1"></i></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <form action="" method="POST">
                            <div class=" row form-group">
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="rechercher dans la bible">
                                </div>
